...
public class Ejercicio8Frases {
    public static void main(String[] args) {
        ...
        System.out.println("Ingresa una palabra o una frase separada por un espacio.");
        cadena.setFrase(in.nextLine());
